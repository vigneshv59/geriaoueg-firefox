...
var options_panel = require("sdk/panel").Panel({
    ...
    contentStyleFile: [data.url("bootstrap/css/bootstrap.min.css"),data.url("bootstrap/css/bootstrap-responsive.min.css"),data.url("chosen.css")],
    contentScriptFile: [data.url("jquery.min.js"),data.url("URI.min.js"),data.url("jquery.URI.min.js"),data.url("bootstrap/js/bootstrap.min.js"),data.url("chosen.jquery.min.js"),data.url("options.js")]
});
