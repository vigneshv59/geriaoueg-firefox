...
var options_panel = require("sdk/panel").Panel({
    ...
    contentScriptFile: [data.url("jquery.min.js"),data.url("bootstrap/js/bootstrap.min.js"),data.url("options.js")]
});
...
options_panel.port.on('simple-storage-get-f-t-lang', function() {
    options_panel.port.emit('recieve-stored-langs',{"to_lang":ss.t_lang,"fr_lang":ss.f_lang});
});
